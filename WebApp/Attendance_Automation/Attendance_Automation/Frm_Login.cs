...
namespace Attendance_Automation
{
    public partial class Frm_Login : Form
    {
        ...
        {
            new Frm_SplashScreen().ShowDialog();
        }
        //----------------------------------------------------------
        ...
        private void btn_Login_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لطفا اتصال سیستم خود را با اینترنت بررسی کنید", "خطا", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Frm_Login_Load(object sender, EventArgs e)
        {
            if(Functions.IsConnectedtoInternet())
            {
                lbl_stateConnectNet.Text = "متصل";
                lbl_stateConnectNet.ForeColor = Color.Green;
            }
            else
            {
                lbl_stateConnectNet.Text = "عدم اتصال";
                lbl_stateConnectNet.ForeColor = Color.Red;
            }
        }
